...
struct _opcode_dict_t {
	...
	struct _hashtab_t overrides_by_stub;
};

struct _opcode_stub_override_t {
	struct _opcode_stub_override_t* next;
	long offset;
	word_t argc;
...
struct _thread_t {
	...
	struct _generic_stack_t set_stack;
	volatile word_t IP;
...
struct _vm_set_t {
	struct _data_stack_entry_t hash;
	struct _data_stack_entry_t compare;
	struct _hashtab_t tab;
};
...
#define DATA struct _data_stack_entry_t


struct _vobj_t {
#define OBJ_STRUC \
	DATA _isA;     /* self.isA(class) => boolean */ \
	DATA _super;   /* obj/array[obj] ? */ \
	DATA _class;	/* class */
	OBJ_STRUC
};
...
struct _vclass_t {
	OBJ_STRUC	/* header */
	DATA _name;	/* string */
	DATA _base; 	/* obj/array[obj] ? */
	DATA _cast_to;	/* array[fun] */
	DATA _cast_from;	/* array[fun] */
	DATA _overrides; /* set[stub:fun] */
};

/*struct _vclass_t {*/
	/*struct _data_stack_entry_t _base;*/ /* allow for single or multiple inheritance */
	/*struct _data_stack_entry_t _cast_to_class;*/
	/*char* _name;*/
	/*struct _hashtab_t _overrides;*/
