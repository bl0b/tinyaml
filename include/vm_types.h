...
typedef struct _vm_set_t* vm_set_t;
...
typedef enum {
	...
	DataObjSet,			/*!< Managed \ref vm_set_t "unordered associative container */
...
typedef struct _vclass_t* vobj_class_t;
...
typedef struct _opcode_stub_override_t* opcode_stub_override_t;
/*@}*/
